...
public class AppSelectorImplTest {
    ...
    public void setServices_rejectsDuplicateServices() {
        ...
        RuntimeException ex = assertThrows(RuntimeException.class, () -> appSelector.setServices(List.of(service1Bis, service1, service2Bis, service2, service3)));
    ...
    public void selectApp_notFound() {
        NoMatchingAppException ex = assertThrows(NoMatchingAppException.class, () -> appSelector.selectApp("unknown-app"));
